...
void Copy(BlasInt n, const float* x, BlasInt incx, float* y, BlasInt incy);
void Copy(BlasInt n, const double* x, BlasInt incx, double* y, BlasInt incy);
void Copy(BlasInt n,
          const scomplex* x,
          BlasInt incx,
          scomplex* y,
...
double
Dot(BlasInt n, const double* x, BlasInt incx, const double* y, BlasInt incy);

template <typename T>
T Dotc(BlasInt n, const T* x, BlasInt incx, const T* y, BlasInt incy);
double
Dotc(BlasInt n, const double* x, BlasInt incx, const double* y, BlasInt incy);

template <typename T>
T Dotu(BlasInt n, const T* x, BlasInt incx, const T* y, BlasInt incy);
double
Dotu(BlasInt n, const double* x, BlasInt incx, const double* y, BlasInt incy);

...
inline std::string
get_trainer_checkpoint_dirname(const std::string& trainer_name,
...
inline std::string
get_last_shared_checkpoint_filename(const std::string& alg_name,
                                    const std::string& dir)
{
...
inline std::string
get_last_shared_checkpoint_filename(const std::string& trainer_name,
                                    const std::string& alg_name,
                                    const std::string& dir)
{
...
inline std::string get_shared_checkpoint_dirname(const std::string& alg_name,
                                                 const std::string& dir,
                                                 visitor_hook hook,
                                                 execution_mode mode,
                                                 size_t epoch,
...
inline std::string
get_shared_checkpoint_dirname(const std::string& trainer_name,
                              const std::string& alg_name,
                              const std::string& dir,
                              visitor_hook hook,
                              execution_mode mode,
...
inline std::string
get_distributed_checkpoint_dirname(const std::string& alg_name,
...
inline std::string
get_distributed_checkpoint_dirname(const std::string& trainer_name,
                                   const std::string& alg_name,
                                   const int rank_in_trainer,
                                   const std::string& dir,
                                   visitor_hook hook,
...
// from.
inline bool write_latest(std::string filename,
                         visitor_hook hook,
                         execution_mode mode,
                         size_t epoch,
                         size_t train)
 ...
 */
inline bool read_latest(std::string filename,
                        visitor_hook* hook,
                        execution_mode* mode,
                        size_t* epochLast,
                        size_t* trainLast)
